...
if(VCPKG_TARGET_IS_WINDOWS)
   set(OPTIONS "${OPTIONS} --disable-programs --disable-muxers --disable-demuxers --disable-filters --disable-bsfs --disable-protocols --disable-devices --disable-decoder=h264")
...
elseif(VCPKG_TARGET_IS_IOS)
    #set(OPTIONS "${OPTIONS} --disable-securetransport") # To avoid AppStore rejection by disabling the use of private API SecIdentityCreate()
    #set(OPTIONS "${OPTIONS} --enable-encoder=aac_at,h264_videotoolbox,h265_videotoolbox,libmp3lame --enable-decoder=aac,aac_at,h264,h264_videotoolbox,h265_videotoolbox,mp3*,mpeg4,pcm*")
    set(OPTIONS "${OPTIONS} --extra-ldflags=-Wl,-ld_classic")
endif()
...
#elseif(VCPKG_TARGET_IS_IOS)
    #string(APPEND OPTIONS " --target-os=iOS --enable-avfoundation --enable-coreimage --enable-audiotoolbox --enable-videotoolbox")
...
message("XAJM - ffmpeg portfile.cmake 2")
# Release build
