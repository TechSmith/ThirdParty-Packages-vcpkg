param(
    ...
    [PSObject]$PublishDirs = $false,                         # Optional info on what to publish or not publish to the final artifact
...
Run-PrestageAndFinalizeBuildArtifactsStep -linkType $LinkType -buildType $BuildType -publishDirs $PublishDirs
